...
package io.api.resource;

import io.api.exception.NotFoundException;
import io.swagger.annotations.*;
import io.swagger.annotations.ApiResponse;
import io.api.data.PetData;
import io.api.model.Pet;
...
public class PetResource {
  ...
  @ApiOperation(value = "uploads an image",
    response = io.api.model.ApiResponse.class)
  public Response uploadFile(
    ...
    try {
      ...
      io.api.model.ApiResponse output = new io.api.model.ApiResponse(200, msg);
